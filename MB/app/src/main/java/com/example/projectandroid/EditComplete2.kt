...
import kotlinx.android.synthetic.main.activity_edit_complete.btn_editComplete
import kotlinx.android.synthetic.main.activity_edit_complete2.*

class EditComplete2 : AppCompatActivity() {
    var idusername =""
    var username = ""
    var password = ""
    var address = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_edit_complete2)
        admin_editComplete.setOnClickListener(){
            Toast.makeText(this@EditComplete2, "กลับสู่หน้าหลัก", Toast.LENGTH_SHORT).show()
            val intent = Intent(this@EditComplete2, Admin_Home::class.java)
